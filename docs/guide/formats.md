...
5. If your deployment is offline or CSP-restricted, run `npx --yes file-viewer-copy-assets ./public/file-viewer` and point renderer assets to your own static path.
